...
// type="ResServerTest.Web.Controls.ResSrvHandler, ResServerTest.Web.Controls"
// />
// </httpHandlers>
//
...
// ============================================================================
// 1.0.0.0  03/25/2003  EFW  Created the code
// 1.0.1.0  04/07/2003  EFW  Converted from Web.UI.Page to Web.IHttpHandler
// 1.0.2.0  07/19/2003  EFW  Added notes to docs about use with forms-based
...
namespace ResServerTest.Web.Controls
{
	...
	public class ResSrvHandler : System.Web.IHttpHandler
	{
        ...
        /// <b>ResServerTest.Web.Controls.aspx</b>.
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
		{
            ...
            try
            {
                ...
                else
                {
                    ...
                    string strSearchName = context.Request.QueryString["Assembly"];
        	...
        	catch(Exception excp)
            {
                ...
                switch(strType)
                {
                    ...
                    case "vbs":
                        context.Response.ContentType = "text/vbscript";
                        context.Response.Write("MsgBox \"Could not load resource '" +
                            strResName + "': " + strMsg + "\"");
                        break;
